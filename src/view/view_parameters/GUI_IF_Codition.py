...
class If_Condition_Panel ( wx.Panel ):
	...
	def __init__( self, parent ):
		...
		head_sizer.Add( self.m_choice_choosecontrol, 0, wx.ALL|wx.ALIGN_CENTER_HORIZONTAL|wx.ALIGN_CENTER_VERTICAL|wx.EXPAND, 5 )
		
		self.m_button_add = wx.Button( self, wx.ID_ANY, u"增加条件", wx.DefaultPosition, wx.Size( -1,-1 ), 0 )
		head_sizer.Add( self.m_button_add, 0, wx.LEFT|wx.RIGHT|wx.ALIGN_CENTER_HORIZONTAL, 5 )
		
		self.m_button_setting = wx.Button( self, wx.ID_ANY, u"设置", wx.DefaultPosition, wx.DefaultSize, 0 )
		self.m_button_setting.Enable( False )
		
		head_sizer.Add( self.m_button_setting, 0, wx.ALIGN_CENTER_HORIZONTAL|wx.RIGHT|wx.LEFT, 5 )
		...
		self.m_button_setting.Bind( wx.EVT_BUTTON, self.edit_setting )
